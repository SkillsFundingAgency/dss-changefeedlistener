...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class OutcomeChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _outcomeTrigger = new OutcomeChangeFeedTrigger.OutcomeChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsOutcomeAsTrue_WhenDocumentIsValid()
        {
            ...
            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsOutcome == true)));
        }
