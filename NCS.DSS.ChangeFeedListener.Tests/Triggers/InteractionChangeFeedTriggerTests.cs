...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class InteractionChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _interactionTrigger = new InteractionChangeFeedTrigger.InteractionChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsInteractionAsTrue_WhenDocumentIsValid()
        {
            ...
            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsInteraction == true)));
        }
