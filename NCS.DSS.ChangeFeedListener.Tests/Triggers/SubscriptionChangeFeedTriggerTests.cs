...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class SubscriptionChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _subscriptionTrigger = new SubscriptionChangeFeedTrigger.SubscriptionChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsSubscriptionAsTrue_WhenDocumentIsValid()
        {
            ...
            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsSubscription == true)));
        }
