...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class TransferChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _transferTrigger = new TransferChangeFeedTrigger.TransferChangeFeedTrigger(_serviceBusClient.Object,  _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsTransferAsTrue_WhenDocumentIsValid()
        {
            ...
            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<string>(), It.Is<ChangeFeedMessageModel>(m => m.IsTransfer == true)));
        }
