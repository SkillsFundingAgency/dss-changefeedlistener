...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class EmploymentProgressionChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _employmentProgressionTrigger = new EmploymentProgressionChangeFeedTrigger.EmploymentProgressionChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsEmploymentProgressionAsTrue_WhenDocumentIsValid()
        {
            ...
            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsEmploymentProgression == true)));
        }
