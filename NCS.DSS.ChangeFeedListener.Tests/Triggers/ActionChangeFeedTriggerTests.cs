...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class ActionChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _actionTrigger = new ActionChangeFeedTrigger.ActionChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsActionAsTrue_WhenDocumentIsValid()
        {
            ...
            //Act
            await _actionTrigger.Run(documentsList.AsReadOnly());

            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsAction == true)));
        }
