...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class ContactChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _contactTrigger = new ContactChangeFeedTrigger.ContactChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsContactAsTrue_WhenDocumentIsValid()
        {
            ...
            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsContact == true)));
        }
