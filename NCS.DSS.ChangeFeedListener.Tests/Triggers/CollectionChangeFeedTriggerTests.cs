...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class CollectionChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _collectionTrigger = new CollectionChangeFeedTrigger.CollectionChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsCollectionAsTrue_WhenDocumentIsValid()
        {
            ...
            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsCollection == true)));
        }
