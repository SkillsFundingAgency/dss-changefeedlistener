...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class SessionChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _sessionTrigger = new SessionChangeFeedTrigger.SessionChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsSessionAsTrue_WhenDocumentIsValid()
        {
            ...
            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsSession == true)));
        }
