...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class WebChatChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _webChatTrigger = new WebChatChangeFeedTrigger.WebChatChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsWebChatAsTrue_WhenDocumentIsValid()
        {
            ...
            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsWebChat == true)));
        }
