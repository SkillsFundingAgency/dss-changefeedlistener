...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class LearningProgressionChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _learningProgressionTrigger = new LearningProgressionChangeFeedTrigger.LearningProgressionChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsLearningProgressionAsTrue_WhenDocumentIsValid()
        {
            ...
            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsLearningProgression == true)));
        }
