...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class ActionPlanChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _actionPlanTrigger = new ActionPlanChangeFeedTrigger.ActionPlanChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsActionPlanAsTrue_WhenDocumentIsValid()
        {
            ...
            //Act
            await _actionPlanTrigger.Run(documentsList.AsReadOnly());

            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsActionPlan == true)));
        }
