...
{
    public class ActionPlanChangeFeedTriggerTests
    {
        private Mock<ILogger<ActionPlanChangeFeedTrigger.ActionPlanChangeFeedTrigger>> _logger;
        
        private Mock<IChangeFeedListenerServiceBusClient> _serviceBusClient;
        private ActionPlanChangeFeedTrigger.ActionPlanChangeFeedTrigger _actionPlanTrigger;
        ...
        public void Setup()
        {
            _logger = new Mock<ILogger<ActionPlanChangeFeedTrigger.ActionPlanChangeFeedTrigger>>();
            
            _serviceBusClient = new Mock<IChangeFeedListenerServiceBusClient>();
            _actionPlanTrigger = new ActionPlanChangeFeedTrigger.ActionPlanChangeFeedTrigger(_serviceBusClient.Object,  _logger.Object);
        ...
        [Test]
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsActionPlanAsTrue_WhenDocumentIsValid()
        {
            //Arrange
            ...
            //Act
            await _actionPlanTrigger.Run(_documentsList.AsReadOnly());

            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<string>(), It.Is<ChangeFeedMessageModel>(m => m.IsActionPlan == true)));
        }
