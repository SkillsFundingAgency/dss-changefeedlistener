...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class CustomerChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _customerTrigger = new CustomerChangeFeedTrigger.CustomerChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsCustomerAsTrue_WhenDocumentIsValid()
        {
            ...
            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsCustomer == true)));
        }
