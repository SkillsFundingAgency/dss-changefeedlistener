...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class AddressChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _addressTrigger = new AddressChangeFeedTrigger.AddressChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsAddressAsTrue_WhenDocumentIsValid()
        {
            ...
            //Act
            await _addressTrigger.Run(documentsList.AsReadOnly());

            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsAddress == true)));
        }
