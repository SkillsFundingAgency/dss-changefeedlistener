...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class GoalChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _goalTrigger = new GoalChangeFeedTrigger.GoalChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsGoalAsTrue_WhenDocumentIsValid()
        {
            ...
            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsGoal == true)));
        }
