...
namespace NCS.DSS.ChangeFeedListener.Tests.Triggers
{
    public class AdviserDetailChangeFeedTriggerTests
    {
        ...
        public void Setup()
        {
            ...
            _adviserDetailTrigger = new AdviserDetailChangeFeedTrigger.AdviserDetailChangeFeedTrigger(_serviceBusClient.Object, _loggerHelper.Object, _logger.Object);
        ...
        public async Task Run_CallsServiceBusClientMethodWithModelPropertyIsAdviserDetailAsTrue_WhenDocumentIsValid()
        {
            ...
            //Assert
            _serviceBusClient.Verify(s => s.SendChangeFeedMessageAsync(It.IsAny<Document>(), It.Is<ChangeFeedMessageModel>(m => m.IsAdviserDetail == true)));
        }
