...
namespace NCS.DSS.ChangeFeedListener.SessionChangeFeedTrigger
{
    public class SessionChangeFeedTrigger
    {
            ...
            )] IReadOnlyList<JsonDocument> documents)
        {
            ...
            {
                _logger.LogInformation("Attempting to Send {Count} Documents from Session Cosomos DB to Service Bus", documents.Count);
                ...
                _logger.LogInformation("Successfully Sent {Count} Documents from Session Cosomos DB to Service Bus", documents.Count);
            }
            else
            {
