...
namespace NCS.DSS.ChangeFeedListener.CollectionChangeFeedTrigger
{
    public class CollectionChangeFeedTrigger
    {
            ...
            )] IReadOnlyList<JsonDocument> documents)
        {
            ...
            {
                _logger.LogInformation("Attempting to Send {Count} Documents from Collection Cosomos DB to Service Bus", documents.Count);
                ...
                _logger.LogInformation("Successfully Sent {Count} Documents from Collection Cosomos DB to Service Bus", documents.Count);
            }
            else
            {
