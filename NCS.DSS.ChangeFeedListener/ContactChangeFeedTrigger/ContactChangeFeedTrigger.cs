...
namespace NCS.DSS.ChangeFeedListener.ContactChangeFeedTrigger
{
    public class ContactChangeFeedTrigger
    {
            ...
            )] IReadOnlyList<JsonDocument> documents)
        {
            ...
            {
                _logger.LogTrace("Attempting to Send {Count} Documents from Contact Cosomos DB to Service Bus", documents.Count);
                ...
                _logger.LogTrace("Successfully Sent {Count} Documents from Contact Cosomos DB to Service Bus", documents.Count);
            }
            else
            {
