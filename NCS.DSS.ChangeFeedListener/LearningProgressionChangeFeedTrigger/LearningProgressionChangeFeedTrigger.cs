...
namespace NCS.DSS.ChangeFeedListener.LearningProgressionChangeFeedTrigger
{
    public class LearningProgressionChangeFeedTrigger
    {
            ...
            )] IReadOnlyList<JsonDocument> documents)
        {
            ...
            {
                _logger.LogTrace("Attempting to Send {Count} Documents from LearningProgression Cosomos DB to Service Bus", documents.Count);
                ...
                _logger.LogTrace("Successfully Sent {Count} Documents from LearningProgression Cosomos DB to Service Bus", documents.Count);
            }
            else
            {
