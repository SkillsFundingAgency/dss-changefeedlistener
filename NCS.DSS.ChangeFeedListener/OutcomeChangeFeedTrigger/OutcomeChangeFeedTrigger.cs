...
namespace NCS.DSS.ChangeFeedListener.OutcomeChangeFeedTrigger
{
    public class OutcomeChangeFeedTrigger
    {
            ...
            )] IReadOnlyList<JsonDocument> documents)
        {
            ...
            {
                _logger.LogTrace("Attempting to Send {Count} Documents from Outcome Cosomos DB to Service Bus", documents.Count);
                ...
                _logger.LogTrace("Successfully Sent {Count} Documents from Outcome Cosomos DB to Service Bus", documents.Count);
            }
            else
            {
