...
namespace NCS.DSS.ChangeFeedListener.EmploymentProgressionChangeFeedTrigger
{
    public class EmploymentProgressionChangeFeedTrigger
    {
            ...
            )] IReadOnlyList<JsonDocument> documents)
        {
            ...
            {
                _logger.LogTrace("Attempting to Send {Count} Documents from EmploymentProgression Cosomos DB to Service Bus", documents.Count);
                ...
                _logger.LogTrace("Successfully Sent {Count} Documents from EmploymentProgression Cosomos DB to Service Bus", documents.Count);
            }
            else
            {
