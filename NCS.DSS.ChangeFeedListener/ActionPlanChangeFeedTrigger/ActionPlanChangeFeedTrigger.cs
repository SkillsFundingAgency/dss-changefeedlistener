...
namespace NCS.DSS.ChangeFeedListener.ActionPlanChangeFeedTrigger
{
    public class ActionPlanChangeFeedTrigger
    {
            ...
            )] IReadOnlyList<JsonDocument> documents)
        {
            ...
            {
                _logger.LogInformation("Attempting to Send {Count} Documents from Action Plan Cosomos DB to Service Bus", documents.Count);
                ...
                _logger.LogInformation("Successfully Sent {Count} Documents from Action Plan Cosomos DB to Service Bus", documents.Count);
            }
            else
            {
